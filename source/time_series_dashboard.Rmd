...
selectInput(
  "state_choice2",
  label = h3("Select State # 2 to Compare"),
...
selectInput(
  "state_choice3",
  label = h3("Select State # 3 to Compare"),
...
#           num_type == input$count_choice) %>%
    ...
    layout(
      xaxis = list(title = "Date", range = c(~min_date, Sys.Date()),
      yaxis = list(title = "No. Cases"),
      shapes = list(
        list(
          type = "rect",
          fillcolor = "#D14124", line = list(color = "#D14124"), opacity = 0.3,
          x0 = ~start_close, x1 = ~end_close, xref = "x",
          y0 = 0, y1 = ~max_val, yref = "y"
        ),
        list(
          type = "rect",
          fillcolor = "#D0D0CE", line = list(color = "#D0D0CE"), opacity = 0.3,
