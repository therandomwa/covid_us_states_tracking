...
# load Aijin's data
df_aw = read.csv("../Data/raw_states/meta_2021-01-05_aw.csv")
...
df_as = load_object("../manual_data/manual_data_20210105_as.rda")
...
df_hp = load_object("../manual_data/manual_data_20210104_hhp.rda")
# df_gl = load_object("../manual_data/manual_data_20201221_gl.rda")
df_cbp = rbind(df_lef, df_as, df_hp)
### 1. compile files ----
