...
file_date = Sys.Date() - 9# change accordingly if the editing date is not the scraping date
file_date_name = file_date %>% format("%Y%m%d")

# load Aijin's data
df_aw = read.csv("../Data/raw_states/meta_2020-11-24_aw.csv")

# load Chistian's data
# df_cbp = load_object("../Data/raw_states/meta_2020-09-29-cbp.rda")

# load manual data
df_lef = load_object("../manual_data/manual_data_20201124_lef.rda")
...
df_as = load_object("../manual_data/manual_data_20201124_as.rda")
...
df_gl = load_object("../manual_data/manual_data_20201124_gl.rda")
