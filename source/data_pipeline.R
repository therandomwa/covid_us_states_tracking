...
# load Aijin's data
df_aw = read.csv("../Data/raw_states/meta_2020-07-20_aw.csv")

# load Chistian's data
df_cbp = load_object("../Data/raw_states/meta_2020-07-20-cbp.rda")

# load manual data
df_lef = load_object("../manual_data/manual_data_20200720_lef.rda")
...
df_as = load_object("../manual_data/manual_data_20200720_as.rda")
...
df_gl = load_object("../manual_data/manual_data_20200720_gl.rda")
