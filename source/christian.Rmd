...
florida = get_florida("../pdfs/florida_20200601.pdf")
...
```{r}
# add new hampshire, south carolina
full_data_20200531 = full_data_20200531 %>% 
  filter(state_name %in% c("New Hampshire", "South Carolina"))
```

```{r}
full_data_20200601 = bind_rows(
  full_data_20200531,
  florida,
  oklahoma,
  mississippi,
...
save(full_data_20200601, file ="../data/raw_states/meta_2020-06-01-cbp.rda")
```
