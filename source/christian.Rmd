...
florida = get_florida("../pdfs/florida_20200525.pdf")
tennessee = get_tennessee(date = "20200525")
...
automated_data_20200525 = bind_rows(
  oklahoma,
  mississippi,
  florida,
  tennessee,
...
full_data_20200525 = bind_rows(automated_data_20200525, manual_data_20200523)


save(full_data_20200525, file = "../data/raw_states/meta_2020-05-25-cbp.rda")
```
