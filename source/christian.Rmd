...
automated_data_20200520 = bind_rows(
  oklahoma,
  mississippi,
  florida,
  tennessee,
...
```{r}
full_data_20200521 = bind_rows(automated_data_20200520, manual_data_20200521)
save(manual_data_20200521, file = "../data/raw_states/manual_states_2020-05-21-cbp.rda")

save(full_data_20200521, file = "../data/raw_states/meta_2020-05-21-cbp.rda")
```
