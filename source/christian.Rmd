...
```{r}
today_url = "https://ghs.guam.gov/jic-release-no-116-end-day-results-zero-test-positive-covid-19-dphss"
...
- t-time with melanie, margaret, rachel and joy 1pm

- finsih up the functions writing (group_by and summary)
- finish up the map (list cols and summarization)
