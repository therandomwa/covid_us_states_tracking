...
get_hawaii = function() {
  ...
  skeleton[["cases"]][["race_asian"]] = get_information2("HI: Cases race asian %?: ")
  skeleton[["cases"]][["race_white"]] = get_information2("HI: Cases race white %?: ")
  skeleton[["cases"]][["race_pac"]] = get_information2("HI: Cases race Native Hawaiian %?: ")
  skeleton[["cases"]][["race_AfrA"]] = get_information2("HI: Cases race AfrA %?: ")
  skeleton[["cases"]][["race_other"]] = get_information2("HI: Cases race other %?: ")
  skeleton[["cases"]][["race_multi"]] = get_information2("HI: Cases race multirace %?: ")
